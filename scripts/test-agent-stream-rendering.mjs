...
assert.match(timeline, /isLiveTimeline\(status\) \? liveActivityItems\(visible, provider\) : settledActivityItems\(visible\)/);
...
assert.match(conversationStyles, /@keyframes activity-current-enter/);
