  ...
  return <section className="content-view settings-view">
    ...
    {settingsSection === "ai" && aiSettingsPage === "providers" && <div id="native-provider-settings" className="settings-section settings-ai-models">
      ...
      <div className="settings-provider-config-grid">
        {claudeProviderControl && <ProviderSettingsPanel control={claudeProviderControl} focused={providerTab === "claude"} subtitle="Anthropic Messages API" onFocus={() => onProviderChange("claude")}><div className="settings-grid">
        ...
        </div></ProviderSettingsPanel>}
        {codexProviderControl && <ProviderSettingsPanel control={codexProviderControl} focused={providerTab === "codex"} subtitle="OpenAI-compatible API" onFocus={() => onProviderChange("codex")}><div className="settings-grid">
