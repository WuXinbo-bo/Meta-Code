...
export function GitWorkbench({ workspaceId }: { workspaceId: string }) {
  ...
  const load = async (background = false) => {
    ...
    setError("");
    try {
      const [nextStatus, nextBranches, nextCommits, nextRemotes] = await Promise.all([
      ...
      setStatus(nextStatus); setBranches(nextBranches); setCommits(nextCommits.commits); setRemotes(nextRemotes);
